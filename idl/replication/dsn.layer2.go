...
type QueryCfgRequest struct {
	...
	IsStandbyRequest *bool   `thrift:"is_standby_request,3" db:"is_standby_request" json:"is_standby_request,omitempty"`
}
...
var QueryCfgRequest_IsStandbyRequest_DEFAULT bool

func (p *QueryCfgRequest) GetIsStandbyRequest() bool {
	if !p.IsSetIsStandbyRequest() {
		return QueryCfgRequest_IsStandbyRequest_DEFAULT
	}
	return *p.IsStandbyRequest
}
func (p *QueryCfgRequest) IsSetIsStandbyRequest() bool {
	return p.IsStandbyRequest != nil
}
...
func (p *QueryCfgRequest) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadBool(); err != nil {
		return thrift.PrependError("error reading field 3: ", err)
	} else {
		p.IsStandbyRequest = &v
	}
	return nil
}
...
func (p *QueryCfgRequest) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetIsStandbyRequest() {
		if err := oprot.WriteFieldBegin("is_standby_request", thrift.BOOL, 3); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:is_standby_request: ", p), err)
		}
		if err := oprot.WriteBool(bool(*p.IsStandbyRequest)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.is_standby_request (3) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 3:is_standby_request: ", p), err)
		}
	}
	return err
}
...
type QueryCfgResponse struct {
	...
	StandbyReadEnabled *bool                     `thrift:"standby_read_enabled,6" db:"standby_read_enabled" json:"standby_read_enabled,omitempty"`
	StandbyReadRatio   *float64                  `thrift:"standby_read_ratio,7" db:"standby_read_ratio" json:"standby_read_ratio,omitempty"`
}
...
var QueryCfgResponse_StandbyReadEnabled_DEFAULT bool

func (p *QueryCfgResponse) GetStandbyReadEnabled() bool {
	if !p.IsSetStandbyReadEnabled() {
		return QueryCfgResponse_StandbyReadEnabled_DEFAULT
	}
	return *p.StandbyReadEnabled
}

var QueryCfgResponse_StandbyReadRatio_DEFAULT float64

func (p *QueryCfgResponse) GetStandbyReadRatio() float64 {
	if !p.IsSetStandbyReadRatio() {
		return QueryCfgResponse_StandbyReadRatio_DEFAULT
	}
	return *p.StandbyReadRatio
}
func (p *QueryCfgResponse) IsSetErr() bool {
	return p.Err != nil
}

func (p *QueryCfgResponse) IsSetStandbyReadEnabled() bool {
	return p.StandbyReadEnabled != nil
}

func (p *QueryCfgResponse) IsSetStandbyReadRatio() bool {
	return p.StandbyReadRatio != nil
}
...
func (p *QueryCfgResponse) ReadField6(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadBool(); err != nil {
		return thrift.PrependError("error reading field 6: ", err)
	} else {
		p.StandbyReadEnabled = &v
	}
	return nil
}

func (p *QueryCfgResponse) ReadField7(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadDouble(); err != nil {
		return thrift.PrependError("error reading field 7: ", err)
	} else {
		p.StandbyReadRatio = &v
	}
	return nil
}
...
func (p *QueryCfgResponse) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetStandbyReadEnabled() {
		if err := oprot.WriteFieldBegin("standby_read_enabled", thrift.BOOL, 6); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:standby_read_enabled: ", p), err)
		}
		if err := oprot.WriteBool(bool(*p.StandbyReadEnabled)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.standby_read_enabled (6) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 6:standby_read_enabled: ", p), err)
		}
	}
	return err
}

func (p *QueryCfgResponse) writeField7(oprot thrift.TProtocol) (err error) {
	if p.IsSetStandbyReadRatio() {
		if err := oprot.WriteFieldBegin("standby_read_ratio", thrift.DOUBLE, 7); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:standby_read_ratio: ", p), err)
		}
		if err := oprot.WriteDouble(float64(*p.StandbyReadRatio)); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T.standby_read_ratio (7) field write error: ", p), err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field end error 7:standby_read_ratio: ", p), err)
		}
	}
	return err
}
...
type AppInfo struct {
	...
	IsBulkLoading      bool              `thrift:"is_bulk_loading,14" db:"is_bulk_loading" json:"is_bulk_loading,omitempty"`
}
